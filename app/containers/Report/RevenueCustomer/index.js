...
const RevenueCustomer = ({ className, exportExcel }) => {
  ...
  return (
    <>
      <Row className={className} gutter={[16, 16]} style={{ height: 40, marginBottom: 20 }}>
        <Col xs={16}>
...
RevenueCustomer.propTypes = {
  className: PropTypes.any,
};
export default styled(RevenueCustomer)`
