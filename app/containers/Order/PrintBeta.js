    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            fontSize:'45px',
            fontWeight:'bold'
          }}>{ dataBin['source']['code'] && dataBin['source']['code'].substr(0,3)}</span>
          <br />
        ...
        <div style={{
          ...
          <span style={{
            fontSize:'45px',
            fontWeight:'bold'
          }}>{ dataBin['destination']['code'] && dataBin['destination']['code'].substr(0,3)}</span>
          <br />
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontWeight: '900', fontSize: '21px'}}>{convert(dataBin['final_fee'])}</span>
