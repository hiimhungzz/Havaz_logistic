...
const tableOrder = memo(
  ({
    ...
    let columns = [
      ...
      // {
      //   title: "Ngày nhập hàng vào ĐKN",
      //   width: 150,
      //   dataIndex: "current_imported_at",
      //   key: "current_imported_at",
      //   render: (value, record) => moment(value).format("DD-MM-YYYY HH:mm"),
      // },
      {
    ...
    let summary = _info?.count_order > 0 ? (
      <Table.Summary.Row>
        <Table.Summary.Cell ><span style={{ fontWeight: 'bold' }}>Tổng</span> </Table.Summary.Cell>
        <Table.Summary.Cell >{_info?.count_order}</Table.Summary.Cell>
        <Table.Summary.Cell ></Table.Summary.Cell>
        
        {/* <Table.Summary.Cell >{convert(_info?.sum_number_package)}</Table.Summary.Cell> */}
        <Table.Summary.Cell >{convert(_info?.sum_cod)}</Table.Summary.Cell>
        <Table.Summary.Cell >{convert(_info?.receiver_order_fee)}</Table.Summary.Cell>
        <Table.Summary.Cell >{convert(_info?.receiver_payment_price)}</Table.Summary.Cell>
        <Table.Summary.Cell >{convert(_info?.sum_fee)}</Table.Summary.Cell>
        <Table.Summary.Cell >{convert(_info?.sum_order_fee_final)}</Table.Summary.Cell>
        <Table.Summary.Cell >{convert(_info?.cod_fee)}</Table.Summary.Cell>
        <Table.Summary.Cell >{convert(_info?.r_shipping_fee)}</Table.Summary.Cell>
        <Table.Summary.Cell >{convert(_info?.d_shipping_fee)}</Table.Summary.Cell>
