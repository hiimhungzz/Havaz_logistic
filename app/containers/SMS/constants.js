...
export const formatParams = (params) => {
  let param = {
    ...
    'filterBy[sent_date]': params['startDate'] && params['endDate'] ? `${params['startDate']},${params['endDate']}:btw` : undefined,
    'filterBy[order_id]': params['orderCode'] ? params['orderCode'] : undefined,
    'filterBy[phone]': params['phone'] ? `${params['phone']}:like` : undefined,
  }
  return param
}