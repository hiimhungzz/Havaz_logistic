...
const congNoTheoXe = ({ className, definitions }) => {
    ...
    const formatParams = (params) => {
        return {
            ...
            received_hub_id: params.received_hub_id ? params.received_hub_id : undefined,
        }
    }
    ...
    const getListBill = useCallback(async () => {
        ...
        const result = await ServiceBase.requestJson({
            method: "GET",
            url: URI["URI_REPORT_GET_RECEIVED_ORDER"],
            data: {
                ...temp
            },
        });
    ...
    const exportFile = useCallback(async () => {
        ...
        if (result.hasErrors) {
            ...
            downloadFile(url, `Danh sách hàng nhận.xlsx`)
        }
    }, [params]);
