...
const RegionList = memo(({ className, data, params, total, setParams, onEdit, onRefreshList }) => {
  const columns = [
    {
      title: "STT",
      dataIndex: "id",
    ...
    },
    {
      ...
      render: (value, row) => {
        return (
          <div>
            <ItemRegion nameColumn={"active"} value={value} row={row} onRefreshList={onRefreshList} />
          </div>
        );
      },
      width: 100,
...
export default styled(RegionList)`
.ant-table-wrapper {
