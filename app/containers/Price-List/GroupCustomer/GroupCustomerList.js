...
import ItemGroupCustomer from "./ItemGroupCustomer";
import _ from "lodash";
const GroupCustomerList = memo(({ className, data, params, total, setParams, onEdit, onRefreshList }) => {
  const columns = [
    {
      title: "STT",
      dataIndex: "id",
    ...
    },
    {
      ...
      render: (value, row) => {
        return (
          <ItemGroupCustomer nameColumn={"active"} value={value} row={row} />
        );
      },
      width: 100,
      fixed: "right",
...
GroupCustomerList.propTypes = {
  className: PropTypes.any,
};
export default styled(GroupCustomerList)`
.ant-table-wrapper {
