...
export const TEMP_BODY = {
  ...
  'filterBy[delivered_by_id]': undefined,
};

export const TEMP_BODY_HANG_PHAT = {
  total: 19,
  per_page: 10,
  page: 1,
  startDate: undefined,
...
export const formatParams_ton_phat = (params) => {
  let param = {
    per_page: params.per_page ? params.per_page : undefined ,
    page: params.page ? params.page : undefined,
    // startDate: params.startDate ? params.startDate : undefined,
    ...
    'filterBy[id]': params['filterBy[id]'] ? params['filterBy[id]'] : undefined,
    'filterBy[status]': params['filterBy[status]'] ? params['filterBy[status]'] : undefined,
    'filterBy[current_imported_at]': params['startDate'] ? `${params['startDate']},${params['endDate']}:btw` : undefined
  }
  return param
}

export const formatParams_dat_phat = (params) => {
  let param = {
    per_page: params.per_page ? params.per_page : undefined ,
    page: params.page ? params.page : undefined,
    // startDate: params.startDate ? params.startDate : undefined,
    ...
    'filterBy[id]': params['filterBy[id]'] ? params['filterBy[id]'] : undefined,
    'filterBy[receiver_phone]': params['filterBy[receiver_phone]'] ? `${params['filterBy[receiver_phone]']}:like` : undefined,
    'filterBy[delivered_by_id]': params['filterBy[delivered_by_id]'] ? params['filterBy[delivered_by_id]'] : undefined,
    'filterBy[status]': params['filterBy[status]'] ? params['filterBy[status]'] : undefined,
    'filterBy[deliveted_date]': params['startDate'] ? `${params['startDate']},${params['endDate']}:btw` : undefined
  }
  return param
}

export const formatParams_khong_tc = (params) => {
  let param = {
    per_page: params.per_page ? params.per_page : undefined ,
    page: params.page ? params.page : undefined,
    // startDate: params.startDate ? params.startDate : undefined,
    ...
    'filterBy[delivered_by_id]': params['filterBy[delivered_by_id]'] ? params['filterBy[delivered_by_id]'] : undefined,
    'filterBy[status]': params['filterBy[status]'] ? params['filterBy[status]'] : undefined,
    'filterBy[undelivered_at]': params['startDate'] ? `${params['startDate']},${params['endDate']}:btw` : undefined
  }
  return param
}